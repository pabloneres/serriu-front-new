...
export function Orcamentos() {
  ...
  function HandleOrcamento() {
    if (showFormEdit) {
      return <EditarOrcamentoPage onFinish={_ => onFinish()} orcamento={orcamentoSelecionado} alterar={orcamentoSelecionado !== undefined} />
    }

    if (showForm) {
      return <AdicionarOrcamentoPage onFinish={_ => onFinish()} orcamento={orcamentoSelecionado} alterar={orcamentoSelecionado !== undefined} />
    }
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {convertDate(getOrcamento.created_at)}
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  {convertDate(getOrcamento.data_aprovacao)}
                </td>
              </tr>
              <tr>
                <td>
